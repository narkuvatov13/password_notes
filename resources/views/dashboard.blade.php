    ...
    @section('main-content')
        ...
        <div class="p-4 sm:ml-64">
            ...
            <div id="accordion-collapse" data-accordion="collapse">
                ...
                <div id="accordion-collapse-body-password" class="hidden"
                    aria-labelledby="accordion-collapse-heading-password">
                    <div
                        ...
                        @foreach ($passwordItems as $item)
                            <div
                                ...
                                <div class="flex justify-end">
                                    <button id="passwordDropdownButton{{ $loop->iteration }}"
                                    ...
                                    <div id="passwordDropdown{{ $loop->iteration }}"
                                        ...
                                        <ul class="py-2" aria-labelledby="passwordDropdownButton">
                                                    ...
                                                    <template x-teleport="body">
                                                        <div x-show="passwordEditModalOpen"
                                                            ...
                                                            <div x-show="passwordEditModalOpen"
                                                                ...
                                                                @click="passwordEditModalOpen=false"
                                                                class="absolute inset-0 w-full h-full bg-black bg-opacity-40">
                                                            </div>
                                                            <div x-show="passwordEditModalOpen"
                                                                x-trap.inert.noscroll="passwordEditModalOpen"
                                                                x-transition:enter="ease-out duration-300"
                                            ...
                                            <li>
                                                <!-- Delete Modal Button -->
                                                <div x-data="{ passwordDeleteModalOpen: false }"
                                                    @keydown.escape.window="passwordDeleteModalOpen = false"
                                                    class="relative z-50 w-auto h-auto">
                                                    {{-- Delete Modal Button --}}
                                                    ...
                                                    <template x-teleport="body">
                                                        <div x-show="passwordDeleteModalOpen"
                                                            ...
                                                            <div x-show="passwordDeleteModalOpen"
                                                                ...
                                                                x-transition:leave-start="opacity-100"
                                                                x-transition:leave-end="opacity-0"
                                                                @click="passwordDeleteModalOpen=false"
                                                                class="absolute inset-0 w-full h-full bg-black bg-opacity-40">
                                                            </div>
                                                            <div x-show="passwordDeleteModalOpen"
                                                                x-trap.inert.noscroll="passwordDeleteModalOpen"
                                                                x-transition:enter="ease-out duration-300"
                                                                x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                                                                x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100"
                                                                x-transition:leave="ease-in duration-200"
                ...
                <h2 id="accordion-collapse-heading-note">
                    ...
                    <button type="button"
                        class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
                        data-accordion-target="#accordion-collapse-body-note" aria-expanded="true"
                        aria-controls="accordion-collapse-body-note">
                        <span>
                    ...
                    <div
                        ...
                        @foreach ($noteItems as $noteItem)
                            <div
                                ...
                                <div class="flex justify-end">
                                    <button id="noteEditDropdownButton{{ $loop->iteration }}"
                                        data-dropdown-toggle="notEditDropdown{{ $loop->iteration }}"
                                        class="inline-block text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-1.5"
                                        type="button">
                                        <span class="sr-only">{{ __('messages.open_dropdown') }}</span>
                                        <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div id="notEditDropdown{{ $loop->iteration }}"
                                        class="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                                                ...
                                                <div x-data="{ noteEditModalOpen: false }"
                                                    ...
                                                    <template x-teleport="body">
                                                        <div x-show="noteEditModalOpen"
                                                            ...
                                                            <div x-show="noteEditModalOpen"
                                                                x-trap.inert.noscroll="noteEditModalOpen"
                                                                x-transition:enter="ease-out duration-300"
                                                                x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                                                                x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100"
                                                                x-transition:leave="ease-in duration-200"
                                                ...
                                                <div x-data="{ noteDeleteModalOpen: false }"
                                                    ...
                                                    <template x-teleport="body">
                                                        <div x-show="noteDeleteModalOpen"
                                                            ...
                                                            <div x-show="noteDeleteModalOpen"
                                                                x-trap.inert.noscroll="noteDeleteModalOpen"
                                                                x-transition:enter="ease-out duration-300"
                                                                x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                                                                x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100"
                                                                x-transition:leave="ease-in duration-200"
                                                ...
                                                <div x-data="{ addressEditModalOpen: false }"
                                                    ...
                                                    <template x-teleport="body">
                                                        <div x-show="addressEditModalOpen"
                                                            ...
                                                            x-cloak>
                                                            <div x-show="addressEditModalOpen"
                                                                @click="addressEditModalOpen=false"
                                                                x-transition:enter="ease-out duration-300"
                                                                x-transition:enter-start="opacity-0"
                                                                x-transition:enter-end="opacity-100"
                                                                x-transition:leave="ease-in duration-300"
                                                ...
                                                <div x-data="{ addressDeleteModalOpen: false }"
                                                    ...
                                                    <template x-teleport="body">
                                                        <div x-show="addressDeleteModalOpen"
                                                            ...
                                                            x-cloak>
                                                            <div x-show="addressDeleteModalOpen"
                                                                @click="addressDeleteModalOpen=false"
                                                                x-transition:enter="ease-out duration-300"
                                                                x-transition:enter-start="opacity-0"
                                                                x-transition:enter-end="opacity-100"
                                                                x-transition:leave="ease-in duration-300"
                ...
                <h2 id="accordion-collapse-heading-note">
                    ...
                    <button type="button"
                        class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
                        data-accordion-target="#accordion-collapse-body-payment-card" aria-expanded="true"
                ...
                <div id="accordion-collapse-body-payment-card" class="hidden"
                    aria-labelledby="accordion-collapse-body-payment-card">
                    <div
                        class="flex flex-wrap gap-4 md:gap-6 md:justify-start justify-center p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                        ...
                        @foreach ($paymentCards as $paymentCard)
                            <div
                                ...
                                <div class="flex justify-end">
                                    <button id="paymentCardEditDropdownButton{{ $loop->iteration }}"
                                        data-dropdown-toggle="paymentCardEditDropdown{{ $loop->iteration }}"
                                        class="inline-block text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-1.5"
                                        type="button">
                                        <span class="sr-only">{{ __('messages.open_dropdown') }}</span>
                                        <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div id="paymentCardEditDropdown{{ $loop->iteration }}"
                                        class="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                                        <ul class="py-2" aria-labelledby="paymentCardEditDropdownButton">

                                            {{-- Payment Cards Edit Modal --}}
                                            <li>
                                                <div x-data="{ paymentCardEditModalOpen: false }"
                                                    @keydown.escape.window="paymentCardEditModalOpen = false"
                                                    class="relative z-50 w-auto h-auto">
                                                    ...
                                                    <template x-teleport="body">
                                                        <div x-show="paymentCardEditModalOpen"
                                                            ...
                                                            x-cloak>
                                                            <div x-show="paymentCardEditModalOpen"
                                                                @click="paymentCardEditModalOpen=false"
                                                                x-transition:enter="ease-out duration-300"
                                                                x-transition:enter-start="opacity-0"
                                                                x-transition:enter-end="opacity-100"
                                                                x-transition:leave="ease-in duration-300"
                                                            ...
                                                            <div x-show="paymentCardEditModalOpen"
                                                                x-trap.inert.noscroll="paymentCardEditModalOpen"
                                                                x-transition:enter="ease-out duration-300"
                                                                x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                                                                x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100"
                                                                x-transition:leave="ease-in duration-200"
                                                                ...
                                                                <div class="flex items-center justify-between pb-2">
                                                                    <h3 class="text-lg font-semibold">
                                                                        {{ __('messages.payment_card_update') }}
                                                                    </h3>
                                                ...
                                                <div x-data="{ paymentCardDeleteModalOpen: false }"
                                                    ...
                                                    <template x-teleport="body">
                                                        <div x-show="paymentCardDeleteModalOpen"
                                                            ...
                                                            x-cloak>
                                                            <div x-show="paymentCardDeleteModalOpen"
                                                                @click="paymentCardDeleteModalOpen=false"
                                                                x-transition:enter="ease-out duration-300"
                                                                x-transition:enter-start="opacity-0"
                                                                x-transition:enter-end="opacity-100"
                                                                x-transition:leave="ease-in duration-300"
                                                            ...
                                                            <div x-show="paymentCardDeleteModalOpen"
                                                                x-trap.inert.noscroll="paymentCardDeleteModalOpen"
                                                                x-transition:enter="ease-out duration-300"
                                                                x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                                                                x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100"
                                                                x-transition:leave="ease-in duration-200"
                ...
                <h2 id="accordion-collapse-heading-bank-account">
                    ...
                    <button type="button"
                        class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
                        data-accordion-target="#accordion-collapse-body-bank-account" aria-expanded="true"
                        aria-controls="accordion-collapse-body-bank-account">
                        <span>
                ...
                <div id="accordion-collapse-body-bank-account" class="hidden"
                    aria-labelledby="accordion-collapse-body-bank-account">
                    <div
                        class="flex flex-wrap gap-4 md:gap-6 md:justify-start justify-center p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                        ...
                        @foreach ($bankAccounts as $bankAccount)
                            <div
                                ...
                                <div class="flex justify-end">
                                    <button id="bankAccountEditDropdownButton{{ $loop->iteration }}"
                                        data-dropdown-toggle="bankAccountEditDropdown{{ $loop->iteration }}"
                                        class="inline-block text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-1.5"
                                        type="button">
                                        <span class="sr-only" {{ __('messages.open_dropdown') }}</span>
                                            <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div id="bankAccountEditDropdown{{ $loop->iteration }}"
                                        class="z-50 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                                        <ul class="py-2" aria-labelledby="bankAccountEditDropdownButton">

                                            {{-- Bank Account Edit Modal --}}
                                            <li>
                                                <div x-data="{ bankAccountEditModalOpen: false }"
                                                    @keydown.escape.window="bankAccountEditModalOpen = false"
                                                    class="relative z-50 w-auto h-auto">
                                                    {{-- Bank Account Edit Modal Button --}}
                                                    <button @click="bankAccountEditModalOpen=true"
                                                        class="w-full px-4 py-2 text-sm text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white disabled:opacity-50 disabled:pointer-events-none">{{ __('messages.edit') }}</button>
                                                    {{-- Bank Account Edit Modal Body --}}
                                                    <template x-teleport="body">
                                                        <div x-show="bankAccountEditModalOpen"
                                                            class="fixed top-0 left-0 z-[50] flex items-center justify-center w-screen h-screen"
                                                            x-cloak>
                                                            <div x-show="bankAccountEditModalOpen"
                                                                @click="bankAccountEditModalOpen=false"
                                                                x-transition:enter="ease-out duration-300"
                                                                x-transition:enter-start="opacity-0"
                                                                x-transition:enter-end="opacity-100"
                                                                x-transition:leave="ease-in duration-300"
                                                            ...
                                                            <div x-show="bankAccountEditModalOpen"
                                                                x-trap.inert.noscroll="bankAccountEditModalOpen"
                                                                x-transition:enter="ease-out duration-300"
                                                                x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                                                                x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100"
                                                                x-transition:leave="ease-in duration-200"
                                                ...
                                                <div x-data="{ bankAccountDeleteModalOpen: false }"
                                                    ...
                                                    <template x-teleport="body">
                                                        <div x-show="bankAccountDeleteModalOpen"
                                                            ...
                                                            x-cloak>
                                                            <div x-show="bankAccountDeleteModalOpen"
                                                                @click="bankAccountDeleteModalOpen=false"
                                                                x-transition:enter="ease-out duration-300"
                                                                x-transition:enter-start="opacity-0"
                                                                x-transition:enter-end="opacity-100"
                                                                x-transition:leave="ease-in duration-300"
