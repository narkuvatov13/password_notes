                ...
                <div class="flex items-center ms-3">
                    ...
                    <div x-data="{ accountDropdownOpen: false }" class="relative">
                        ...
                        <button @click="accountDropdownOpen=true"
                            ...
                            <img src="https://{{ env('AWS_BUCKET') }}.s3.{{ env('AWS_DEFAULT_REGION') }}.amazonaws.com/images/ggzuR0sUl2vlMR5z1jA9eed4sjwwv8EUMU2JOwIE.jpg"
                                            ...
                                            <div x-show="settingModalOpen" x-trap.inert.noscroll="settingModalOpen"
                                                ...
                                                <div class="relative w-auto">
                                                    ...
                                                    <form action="{{route('settings.update', auth()->user()->id)}}"
                                                        ...
                                                        @submit.prevent="settingSubmitForm($event)" x-data="{
                                                        ...
                                                        <div class="relative z-0 w-full mb-5 group">
                                                            ...
                                                            <svg @mousedown="visibility=!visibility"
                                                                @mouseup="visibility=!visibility"
            ...
            <li>
                <a href="{{route('dashboard')}}"
                    ...
                    <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        fill="currentColor" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path
...
<div x-data="{ addItemsModalOpen: false }" @keydown.escape.window="addItemsModalOpen = false"
    class="relative z-50 w-auto h-auto">
                            ...
                            <div x-show="passwordModalOpen"
                                ...
                                <div x-show="passwordModalOpen" x-trap.inert.noscroll="addItemsModalOpen"
                                    ...
                                    <div class="relative w-auto">
                                        ...
                                        <form class="max-w-md mx-auto" action="{{ route('form.password.store')}}"
                                            method="post">
                                            @csrf
                                            <div class="relative z-0 w-full mb-5 group">
                        ...
                        <template x-teleport="body">
                            <div x-show="paymentModalOpen"
                                ...
                                <div x-show="paymentModalOpen" x-trap.inert.noscroll="paymentModalOpen"
                                    ...
                                    <div class="relative w-auto">
                                        <form class="max-w-md mx-auto" action="{{ route('form.payment_card.store')}}"
                                            method="post">
                                            @csrf
                                            <div class="relative z-0 w-full mb-5 group">
                                                <input type="text" name="title"
                        ...
                        <template x-teleport="body">
                            <div x-show="bankAccountModalOpen"
                                ...
                                <div x-show="bankAccountModalOpen" x-trap.inert.noscroll="addItemsModalOpen"
                                    ...
                                    <div class="relative w-auto">
                                        <form class="max-w-md mx-auto" action="{{ route('form.bank_account.store')}}"
                                            method="post">
                                            @csrf
                                            <div class="relative z-0 w-full mb-5 group">
                                                <input type="text" name="title"
