        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <div
                        class=" flex items-center justify-between border-b-2 border-slate-100 mb-4 font-semibold shadow-sm dark:text-white">
                        <h1
                        ...
                        <p class="font-light text-sm md:text-lg text-gray-500 dark:text-gray-400">
                            OR <a href="{{ route('register') }}"
                                class="font-medium text-primary hover:underline dark:text-primary-500">Create An
                                Account</a>
                        </p>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="text-end">
                                <a href="{{ route('password.forgot.index') }}"
                                    class="text-sm text-gray-500 font-medium hover:underline">{{ __('messages.reset_password') }}</a>
                            </div>
                        </div>


                        <button type="submit"
                            class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Log
                            In</button>
