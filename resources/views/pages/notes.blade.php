    ...
    @section('main-content')
        ...
        <div class="p-4 sm:ml-64">
            <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
                <h1 class="text-xl text-gray-700 font-bold">{{ __('messages.note_items') }}</h1>
            </div>
        </div>
                    ...
                    <div
                                        ...
                                        <div x-data="{ noteEditModalOpen: false }"
                                            ...
                                            <template x-teleport="body">
                                                <div x-show="noteEditModalOpen"
                                                    ...
                                                    <div x-show="noteEditModalOpen" x-trap.inert.noscroll="noteEditModalOpen"
                                                        x-transition:enter="ease-out duration-300"
                                                        ...
                                                        <div class="flex items-center justify-between pb-2">
                                                            <h3 class="text-lg font-semibold">{{ __('messages.note_update') }}
                                                            </h3>
                                            ...
                                            }" class="max-w-md mx-auto" action="{{ route('form.note.update', $noteItem->id)}}"
                                                                method="POST">
                                                                @method('PATCH')
                                                                @csrf
                                                    ...
                                                    <div x-show="noteDeleteModalOpen"
                                                        ...
                                                        <div class="relative w-auto mt-2 px-6 py-3">
                                                            ...
                                                            <p class="text-lg text-gray-800">
                                                                {{ __('messages.delete_this_site') }} - {{$noteItem->name}}</p>
                                                            <div class="mt-4 flex justify-center gap-8 ">
                                                                <button @click="noteDeleteModalOpen=false"
                                                                    class="border shadow-md px-8 py-2 text-md text-black rounded-lg hover:bg-gray-100 ">
                                                                    {{ __('messages.no') }}
                                                                </button>
                                                                <form action="{{route('form.note.destroy', $noteItem->id)}}"
                                                                    method="POST">
                                                                    @method('DELETE')
                                                                    @csrf
                                                                    <button type="submit"
                        ...
                        <div class="flex flex-col items-center  ">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                {{Str::limit($noteItem->name, 25, '...')}} </h5>
                            <p class="font-normal text-gray-700 dark:text-gray-400">{{Str::limit($noteItem->username, 25, '...')}}
                            </p>
                        </div>
                    </div>
                @endforeach
